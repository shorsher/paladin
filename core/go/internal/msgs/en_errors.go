...
var (
	...
	MsgSequencerMaxInflightTransactions          = pde("PD012642", "Max number of inflight transactions (%d) reached. %d transactions delegated, %d already being coordinated, %d rejected")
	...
	MsgSequencerDelegateRejectedMaxInFlightError = pde("PD012648", "Coordinator rejected delegate of transaction %s, max in flight limit reached")
