...
var (
	...
	MsgSequencerMaxInflightTransactions       = pde("PD012642", "Max number of inflight transactions (%d) reached. %d transactions delegated, %d already being coordinated, %d accepted, %d rejected")
