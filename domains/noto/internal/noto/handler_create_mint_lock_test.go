...
func TestCreateMintLock(t *testing.T) {
	...
	require.Len(t, assembleRes.AssembledTransaction.InfoStates, 6) // manifest + spend-unlock-manifest + cancel-unlock-manifest + unlock-data-info + data-info + spend-coin
